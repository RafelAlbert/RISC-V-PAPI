...
#include "events/riscv_bsc_zetta_tc2_events.h"

static int pfm_riscv_detect_bsc_zetta_tc2(void *this)
{
    int ret;
    ...
    if (pfm_riscv_cfg.implementation == BSC_ZETTA_TC2)
        return PFM_SUCCESS;

    return PFM_ERR_NOTSUPP;
}

/* RISC-V BSC Zetta TC2 support */
pfmlib_pmu_t riscv_bsc_zetta_tc2_support = {
    .desc = "RISC-V Zetta TC2 (Lagarto Ox)",
    .name = "riscv_bsc_zetta_tc2",
    .pmu = PFM_PMU_RISCV_BSC_ZETTA_TC2,
    .pme_count = LIBPFM_ARRAY_SIZE(riscv_bsc_zetta_tc2_pe),
    .type = PFM_PMU_TYPE_CORE,
    .supported_plm = RISCV_PLM,
    .pe = riscv_bsc_zetta_tc2_pe,
    .pmu_detect = pfm_riscv_detect_bsc_zetta_tc2,
    .num_cntrs = 2,
    .num_fixed_cntrs = 2,
    .max_encoding = 1,
