 ...
 * File: src/libpfm4/lib/pfmlib_riscv_spacemit_k3.c
 * Description: SpacemiT K3 support.
 */

/* private headers */
#include "pfmlib_priv.h"			/* library private */
#include "pfmlib_riscv_priv.h"
#include "events/riscv_spacemit_k3_events.h"

static int pfm_riscv_detect_spacemit_k3(void *this)
{
    int ret;
    ...
    if (pfm_riscv_cfg.implementation == SPACEMIT_K3)
        return PFM_SUCCESS;

    return PFM_ERR_NOTSUPP;
}

/* RISC-V SpacemiT K3 support */
pfmlib_pmu_t riscv_spacemit_k3_support = {
    .desc = "RISC-V SpacemiT K3",
    .name = "riscv_spacemit_k3",
    .pmu = PFM_PMU_RISCV_SPACEMIT_K3,
    .pme_count = LIBPFM_ARRAY_SIZE(riscv_spacemit_k3_pe),
    .type = PFM_PMU_TYPE_CORE,
    .supported_plm = RISCV_PLM,
    .pe = riscv_spacemit_k3_pe,
    .pmu_detect = pfm_riscv_detect_spacemit_k3,
    .num_cntrs = 16,
    .num_fixed_cntrs = 2,
    .max_encoding = 1,
